    //array of fails
var fails = ["winter", "snow", "walking", "football", "cheerleading", "parking", "driving", "running",
     "skating", "gymnastics"];

    function displayFailImg() {
    
        var fail = $(this).attr("data-name")
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=fails+" + fail + "&limit=10&api_key=KbfjUcGQ46v2IkPygFpVdZBB2jn2cqSo";
